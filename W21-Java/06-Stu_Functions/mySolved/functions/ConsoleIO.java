...
public class ConsoleIO {
  ...
  public static HashMap <String, String> askInfo(HashMap<String, String> student, String info) {
    ...
    System.out.print(String.format("Please enter the student's %s. ", info));
      if (input.hasNext())
        student.put(info, input.next());
